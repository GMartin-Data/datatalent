...
from france_travail import offres
...
class TestFetchAllOffres:
    """Tests pour fetch_all_offres() — pagination."""

    def test_un_seul_batch(self, mock_get, mock_token):
    ...
    def test_plusieurs_batchs(self, mock_get, mock_token):
    ...
    def test_stoppe_si_vide(self, mock_get, mock_token):
...
class TestFetchBatchRateLimit:
    ...
    def test_retry_sur_429(self, mock_get, mock_token):
    ...
    def test_echoue_apres_max_retries(self, mock_get, mock_token):
...
class TestFetchBatchTokenExpire:
    ...
    def test_retry_sur_401(self, mock_get, mock_token, mock_invalidate):
